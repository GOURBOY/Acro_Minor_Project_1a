...
<head>
    ...
    <style>
      ...
      /* marquee{
        background: linear-gradient(90deg, #f5f5f5, #e4f9ff);
      } */
      .hh{
        background: linear-gradient(90deg, #f5f5f5, #e4f9ff);
        height: 50px;
...
<body>
    ...
    <div>
        <!-- <h1 style="text-align: center; color: black; background-color: azure" class="hh">
            Welcome to Atulaya Bharat E-Ticketing Site
        </h1> -->
        <div class="o">
